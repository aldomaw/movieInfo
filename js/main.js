        ...
        output+=`
          <div class="col-md-3">
            <div class="well text-center">
              ...
              <a onclick="movieSelected('${movie.id}')" class="btn btn-primary" href="#">Movie Watch</a>
            </div>
          </div>
        `;
      });
    ...
    let output = `
        <div class="row">
          ...
          <div class="col-md-8">
            <h2>${movie.title}</h2>
            <br>
<iframe width="560" height="315" data-src="https://v2.vidsrc.me/embed/${movie.imdb_id}" frameborder="0" allowfullscreen="1" src="https://v2.vidsrc.me/embed/${movie.imdb_id}"></iframe>
